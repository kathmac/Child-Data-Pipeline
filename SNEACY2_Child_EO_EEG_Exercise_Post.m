...
% 
% eeglab;
workpath = '/Volumes/Data/ZShared/SNEACY/3_SNEACY2_HIIT_Child/SNEACY2_HIIT_EEG/EO_EEG/EO_EEG_Exercise/Post/';  % This is the path to your main processing folder
...
cd([workpath]);
save ( 'SNEACY2_Child_Resting_EEG_Ex_Post', 'alldata');
...
%Excel output
xlswrite('SNEACY2_Child_EO_EEG_Exericse_Post.xls', MasterOutput);
