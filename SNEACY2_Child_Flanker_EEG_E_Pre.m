...
eeglab;
m_path = '/Volumes/Data/ZShared/SNEACY/3_SNEACY2_HIIT_Child/SNEACY2_HIIT_EEG/Flanker_DL_EEG/Flanker_DL_EEG_Exercise/Pre/';  % This is the path to your main processing folder
...
filelist = dir('SA_HIIT_pr*_E_FDL_avg.erp');
...
ERP = pop_savemyerp(ERP, 'erpname', 'SNEACY2_Child_pr_Flanker_E_', 'filename', 'SNEACY2_Child_pr_Flanker_E_.erp', 'filepath', [m_path 'ERPsets/'], 'Warning', 'off');   
pop_export2text( ERP, [m_path 'Export_Excel/GrandAVG/','SNEACY2_Child_pr_Flanker_E_','_erp_export.txt'], [5 6], 'electrodes', 'on', 'precision',4, 'time', 'on', 'timeunit',0.001 );
% % 
% disp(',');
% disp('--------------------------------');
